...
public:
	...
	Wiseman(Speaker& speaker, std::vector<std::unique_ptr<Chopstick>>& chopticks, const std::string& name, int minTimeToThink = 1, int maxTimeToThink = 5, int minTimeToEat = 2, int maxTimeToEat = 10);
	~Wiseman();
